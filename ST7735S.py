...
class ST7735S():
	...
	def set_rotation(self, m):
		...
		if rotation == 0:
			self.data(ST7735_MADCTL_MX | ST7735_MADCTL_MY | ST7735_MADCTL_RGB)
			self._width  = ST7735_TFTWIDTH
			self._height = ST7735_TFTHEIGHT
		elif rotation == 1:
			self.data(ST7735_MADCTL_MY | ST7735_MADCTL_MV | ST7735_MADCTL_RGB)
			self._width  = ST7735_TFTHEIGHT
			self._height = ST7735_TFTWIDTH
		elif rotation == 2:
			self.data(ST7735_MADCTL_RGB)
			self._width  = ST7735_TFTWIDTH
			self._height = ST7735_TFTHEIGHT
		elif rotation == 3:
			self.data(ST7735_MADCTL_MX | ST7735_MADCTL_MV | ST7735_MADCTL_RGB)
			self._width  = ST7735_TFTHEIGHT
			self._height = ST7735_TFTWIDTH
